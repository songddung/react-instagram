                    ...
                    <div className={styles.artdiv}>
                        <div className={styles.good}>
                            <a href='' className={styles.a4}>
                                <div className={styles.img2}>
                                    <img src='/images/좋아요.png' width='12px' height='12px' className={styles.imgimg}></img>
                                    <span className={styles.span}>좋아요</span>
                                </div>
                            </a>
                            ...
                            <a href='' className={styles.a4}>
                                <div className={styles.img2}>
                                    <img src='/images/댓글.png' width='12px' height='12px' className={styles.imgimg}></img>
                                    <span className={styles.span}>댓글</span>
                                </div>
                            </a>

                            <a href='' className={styles.a4}>
                                <div className={styles.img2}>
                                    <img src='/images/답장.png' width='12px' height='12px' className={styles.imgimg}></img>
                                    <span className={styles.span}>스토리 답장</span>
                                </div>
                            </a>

                            <a href='' className={styles.a4}>
                                <div className={styles.img2}>
                                    <img src='/images/리뷰.png' width='12px' height='12px' className={styles.imgimg}></img>
                                    <span className={styles.span}>리뷰</span>
                                </div>
                            </a>
                        ...
                        <div className={styles.photo}>
                            ...
                            <div className={styles.photos}>
                                ...
                                <div className={styles.photoline}>
                                    <img src='/images/dog6.png'width="123px" height="125px"></img>
                                    <img src='/images/dog7.png'width="123px" height="125px"></img>
                                    <img src='/images/dog8.png'width="123px" height="125px"></img>
                                    <img src='/images/dog9.png'width="123px" height="125px"></img>
                                    <img src='/images/dog10.png'width="123px" height="125px"></img>
                                </div>
